...
export const AIFutureSection = ({ selectedVocation }) => { // Removed React.FC and prop types
  ...
  return (
    React.createElement('section', { className: "mb-12" },
      ...
      React.createElement('h4', { key: 'actSetHeading', className: "text-lg font-semibold text-slate-700 mt-10 mb-4 pt-6 border-t border-slate-300", children: "Chapter 4 Activities" }),
      ...
      React.createElement(InteractiveCard, {
        ...
        children: [
          ...
          React.createElement('p', { key: 'futAct1Desc', className: "text-slate-700 mb-2 leading-relaxed", children: "Look at the 'HumanSkillsList' (e.g., problem-solving, teamwork, communication)." }),
          React.createElement('ul', { key: 'futAct1List', className: "list-disc list-inside text-slate-700 mb-2 space-y-1 leading-relaxed", children: [
      ...
      React.createElement(InteractiveCard, {
        ...
        children: [
          ...
          React.createElement('p', { key: 'futAct2Desc', className: "text-slate-700 mb-2 leading-relaxed", children: ["The lesson says AI might change job tasks in ", selectedVocation, "."] }),
          React.createElement('ul', { key: 'futAct2List', className: "list-disc list-inside text-slate-700 mb-2 space-y-1 leading-relaxed", children: [
          ...
          React.createElement('p', { key: 'futAct2Instruction', className: "text-slate-700 mb-2 leading-relaxed", children: "(Small Group discussion)" })
        ]
      }),
      ...
      React.createElement(InteractiveCard, {
        ...
        children: [
          ...
          React.createElement('p', { key: 'futAct3Desc', className: "text-slate-700 mb-2 leading-relaxed", children: ["Imagine a job you might have in ", selectedVocation, " in the future."] }),
          React.createElement('ul', { key: 'futAct3List', className: "list-disc list-inside text-slate-700 mb-2 space-y-1 leading-relaxed", children: [
          ...
          React.createElement('p', { key: 'futAct3Instruction', className: "text-slate-700 mb-2 leading-relaxed", children: "Share your idea with a partner." })
        ]
      }),
      ...
      React.createElement(InteractiveCard, {
        ...
        children: [
          ...
          React.createElement('p', { key: 'futAct4Desc', className: "text-slate-700 mb-2 leading-relaxed", children: ["Each student picks ONE skill from the 'HumanSkillsList' that they think is super important for ", selectedVocation, "."] }),
          React.createElement('p', { key: 'futAct4Prompt', className: "text-slate-700 mb-2 leading-relaxed", children: ["Be ready to tell the class in 1-2 sentences: What is the skill, and why will it still be important even if AI helps with many tasks in ", selectedVocation, "?"] })
        ]
      })
