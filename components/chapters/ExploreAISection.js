    ...
    React.createElement('section', { className: "mb-12" },
      ...
      React.createElement(InteractiveCard, { // This card is explanatory, not a task - remains non-collapsible
        children: [
          ...
          React.createElement('p', { key: 'p3', className: "text-slate-700 mb-4 leading-relaxed" },
            ...
            React.createElement(ResourceLink, { key: 'r2', href: "https://www.youtube.com/watch?v=sg_fuEzFw0g", children: "Watch: What are LLMs?" })
          ),
          React.createElement('div', { key: 'div1', className: "bg-sky-50 p-4 rounded-md border border-sky-200" },
            React.createElement('h4', { key: 'h4a', className: "font-semibold text-sky-700 mb-2" }, "AI is not magic!"),
            React.createElement('p', { key: 'p4', className: "text-sm text-slate-700 leading-relaxed" },
      ...
      React.createElement(InteractiveCard, { // Explanatory - non-collapsible
        children: [
          ...
          React.createElement('h4', { key: 'h4b', className: "font-semibold text-slate-600 mb-2" }, "AI in Vocational Fields (Focus: ", selectedVocation, "):"),
          React.createElement('p', { key: 'p6', className: "text-slate-700 mb-3 leading-relaxed" },
            getVocationSpecificExamples(),
            selectedVocation === Vocation.Elektro && (
              React.createElement(React.Fragment, { key: 'frag1' },
                React.createElement(ResourceLink, { key: 'r4', href: "https://matlabsimulation.com/artificial-intelligence-projects-for-electrical-engineering/", children: "More: AI in Electrical Engineering" }),
                React.createElement(ResourceLink, { key: 'r5', href: "https://blog.exertherm.com/the-impact-of-ai-on-electrical-asset-maintenance", children: "More: AI in Predictive Maintenance" })
              )
            ),
          ...
          React.createElement('p', { key: 'p7', className: "text-slate-700 mt-4 leading-relaxed" },
