  ...
  return (
    React.createElement('section', { className: "mb-12" },
      React.createElement('div', { className: "text-center mb-10" },
        React.createElement('h1', { className: "text-3xl sm:text-4xl md:text-5xl font-bold text-teal-700 mb-3" },
          "AI Learning for Vocational Studies"
        ),
        React.createElement('p', { className: "text-lg text-neutral-600" },
          "Tailored for ",
          React.createElement('span', { className: "font-semibold text-teal-600" }, selectedVocation),
          " and all vocational learners."
        )
      ),
      React.createElement(InteractiveCard, {
        children: [
          React.createElement('h2', { key: 'h2', className: "text-2xl sm:text-3xl font-semibold mb-6 text-teal-700" },
            "Welcome to Your AI Learning Journey!"
          ),
          React.createElement('p', { key: 'p1', className: "text-neutral-700 mb-4 leading-relaxed" },
            ...
            React.createElement('strong', { className: "text-teal-600" }, selectedVocation),
            ", it's important to understand what AI is, how you can use it smartly, and the new opportunities and challenges it brings."
          ),
          React.createElement('p', { key: 'p2', className: "text-neutral-700 mb-4 leading-relaxed" },
            "This page is designed to help you with just that! Here you will learn about:"
          ),
          React.createElement('ul', { key: 'ul', className: "list-disc list-inside text-neutral-700 mb-4 space-y-1 leading-relaxed" },
