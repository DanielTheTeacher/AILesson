    ...
    React.createElement('section', { className: "mb-12" },
      ...
      React.createElement(InteractiveCard, { // Explanatory - non-collapsible
        ...
        children: [
          ...
          React.createElement('ul', { key: 'ul1', className: "list-disc list-inside text-neutral-700 mb-2 space-y-2 leading-relaxed" },
      ...
      React.createElement(InteractiveCard, { // SpotTheLieGame is an activity, so this card is collapsible
        ...
        children: [
          ...
          React.createElement('p', { key: 'p4', className: "text-neutral-700 mb-2 leading-relaxed" },
      ...
      React.createElement(InteractiveCard, { // EscapeTheBubble is an activity, so this card is collapsible
        ...
        children: [
          ...
          React.createElement('p', { key: 'p9', className: "text-neutral-700 mb-2 mt-3 leading-relaxed" },
      ...
      React.createElement('h4', { key: 'actSetHeading', className: "text-lg font-semibold text-neutral-700 mt-10 mb-4 pt-6 border-t border-neutral-300", children: "Chapter 3 Activities - Set 1" }),
